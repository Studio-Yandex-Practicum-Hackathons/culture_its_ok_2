...
PRESS_THE_BUTTON = """Нажмите на кнопку <b><i><u>Оставить отзыв</u></i></b>
и напишите своё мнение об арт-объекте. Можете оставить голосовой отзыв.
Если вы не хотите делиться своим мнением,
нажмите кнопку <b><i><u>Без отзыва</u></i></b>"""
